...
\Cref{tbl:design:ble-positioning:ibeacon1}, \cref{tbl:design:ble-positioning:ibeacon2} and \cref{tbl:design:ble-positioning:ibeacon3} show examples of packets McDonalds could broadcast in order to retrieve information about a users positioning. Amongst others, McDonalds could use this for tracking users and sending them advertisements or offers based on their position.
