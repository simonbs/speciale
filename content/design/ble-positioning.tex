...
Note that all examples are fictitious.
...
\Cref{fig:design:ble-positioning:room} shows an example apartment with a beacon installed in each region of the apartment. The apartment is divided into the following six regions:
