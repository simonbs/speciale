...
\todo[author=Kasper]{Der skal lige sættes en liste af krav ind i dette afsnit her i starten.}
...
\todo[author=Simon]{Uddyb afsnittet om OpenHAB. Hvorfor er det godt? Hvilket API stiller det til rådighed? Hvad understøtter det?}
...
First off we have tried using Homeport once before in \cite{previous-report} and it was not very easy for us to set up and use \todo[author=Simon]{Hvorfor var det ikke let? Hvilke problemer oplevede vi? Kunne ikke starte op og crashes}.
