...
\Cref{tbl:analysis:choice-of-wearable} shows that only two wearables fulfills our requirements, namely the second generation Moto 360 by Motorola and the Gear S2 by Samsung. The other wearables provide access to the an accelerometer but does not provide access to the bluetooth API. In those cases performing the positioning of the user on a smartphone could be a solution, thus requiring the user to carry his phone around with him whenever he use the solution.

Implementing the system on a wearable which gives access to both the bluetooth and the accelerometer APIs seem to be the most attractive solution. Of the two proposed wearables, we find the Moto 360 to be best suited for our project as we already have experience with the Android platform and therefore should be able to make progress on a prototype of the system faster.
