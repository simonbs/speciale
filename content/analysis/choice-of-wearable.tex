...
The following wearables were chosen based on their popularity, availability and a desire to include a watch running each of the major smartwatch operating systems which, as of writing this, is Android Wear, Tizen and Apple Watch \todo[author=Simon]{Are the major smartwatch operating systems a claim or ``broadly accepted''?}. Furthermore we included a Pebble Classic in our analyze as we already had access to one.
