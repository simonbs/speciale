...
The above lists the bare minimum of hardware required in order to implement the system. Section \cref{} provides a detailed analyses of the desired hardware. \todo[author=Simon]{Insert reference to detailed analyses of the hardware required for the system.}
