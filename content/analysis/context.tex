...
We refer to the combination of gesture, room and action as a \emph{gesture configuration} as defined in \Cref{def:gesture-configuration}. Gesture configurations are meant to be configured by a user. For example, a user can configure a circle gesture to turn on the table lamp when he is in the living room.
