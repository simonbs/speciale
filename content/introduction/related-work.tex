...
\Cref{fig:introduction:gesture-control:reemo} illustrates how a user of Reemo points at a smart device and then performs a gesture to send a command, i.e. trigger an action.
