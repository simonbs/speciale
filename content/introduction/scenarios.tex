...
\begin{table}[h]
\centering
\caption{Gestures a user may perform in the apartment shown in \Cref{fig:analysis:scenario:apartment}}
...
\begin{table}[]
\centering
\caption{Gestures that perform actions on controllable devices in each room of the apartment shown in \Cref{fig:analysis:scenario:apartment}.}
...
We consider the following example of a day in a users life realistic to take place in the apartment illustrated in \Cref{fig:analysis:scenario:apartment,tbl:analysis:scenario:rooms} with the gestures outlined in \Cref{tbl:analysis:scenario:gestures}.
...
Sometimes a meaningful action cannot be determined from the context of the user.
...
Instead of ignoring the persons request, a list of alternate actions could be presented to him on his smartwatch. Which actions would be presented however, could be the inverse of the one performed (if applicable) which in this case would be to turn the TV off.
