...
As described in \Cref{sec:evaluation:user-tests}, the system triggers the correct action 44\% of the time. According to the requirement specification presented in \Cref{sec:requirements-specification}, an accuracy of at least 80\% was desired and as such, the system is not satisfiyingly accurate.
