...
In the design of the Bayesian network used for context recognition (see \Cref{sec:design:bayesian-network}) we introduced the state of the system as contextual information and as explained in \Cref{sec:implementation:status}, the functionality was not implemented.
