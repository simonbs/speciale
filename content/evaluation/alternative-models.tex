...
As the users tests described in \Cref{sec:evaluation:user-tests} showed that the system had an accuracy of 44\% \ie the correct action was triggered in 44\% of the cases, alternative models were considered. This section describes some of the alternative models that were considered and whether or not they addressed the issues raised in \Cref{sec:evaluation-user-tests-conclusion}.
...
\begin{table}[]
\centering
\caption{Average scores of gestures used when computing the beliefs for the ``Belief after'' column shown in \Cref{sec:evaluation:alternative-models:improved-beliefs}.}
